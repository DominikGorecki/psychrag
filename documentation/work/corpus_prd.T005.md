...
### Test Case 1: Single scrollbar in inspect_original_md
**Preconditions:** Database has converted work with original markdown
**Steps:**
1. Navigate to `/conv/{id}/inspect_original_md` for a work with long content
2. Observe the page layout
3. Count the scrollbars on the page
4. Scroll down through the content
5. Observe header behavior

**Expected result:**
- Only one scrollbar visible (browser's right-side scrollbar)
- No scrollbar within the content area
- Content scrolls smoothly in browser
- Header remains visible at top while scrolling (sticky)

### Test Case 2: Single scrollbar in corpus viewer
**Preconditions:** Database has corpus work with long sanitized content
**Steps:**
1. Navigate to `/corpus/{id}` for a work with long content
2. Observe the page layout
3. Count the scrollbars on the page
4. Scroll down through the content
5. Observe header behavior
...
### Test Case 3: Short content handling
**Preconditions:** Corpus work with very short content (< 1 screen)
**Steps:**
1. Navigate to `/corpus/{id}` for work with short content
2. Observe page layout
3. Check if scrollbar appears

**Expected result:**
- No scrollbar appears (content fits in viewport)
- Page is at least full viewport height
- Header is at top
- Content is properly positioned

### Test Case 4: Sticky header functionality
**Preconditions:** Viewing long content in either page
**Steps:**
...
**Expected result:**
- Header stays at top of viewport while scrolling
- Header doesn't scroll out of view
- Back/Save buttons remain accessible
- Header doesn't overlap content (has proper z-index)

### Test Case 5: Keyboard scrolling
**Preconditions:** Viewing long content
**Steps:**
1. Navigate to page with long content
2. Click in content area to focus
3. Press arrow down key repeatedly
4. Press Page Down
5. Press End key

**Expected result:**
- Arrow keys scroll browser viewport naturally
- Page Down scrolls one viewport height
- End key jumps to bottom of page
- All scrolling is smooth and natural

### Test Case 6: Cross-browser consistency
**Preconditions:** Access to multiple browsers
**Steps:**
1. Open inspect_original_md page in Chrome
2. Observe scroll behavior
3. Open same page in Firefox
4. Compare behavior
5. Repeat in Safari (if on Mac)

**Expected result:**
- All browsers show single scrollbar
- Sticky header works in all browsers
- No browser-specific quirks or double scrollbars
- Scrolling is smooth in all browsers

### Test Case 7: Mobile scrolling (iOS)
**Preconditions:** Access to iPhone or iOS simulator
**Steps:**
1. Navigate to corpus viewer on iPhone
2. Scroll through content with finger swipe
3. Observe header behavior
4. Check for nested scroll areas

**Expected result:**
- Single scroll area (browser viewport)
- No nested scrollable divs
- Smooth touch scrolling
- Header behavior appropriate for mobile (may not be sticky on iOS)

### Test Case 8: Mobile scrolling (Android)
**Preconditions:** Access to Android device
**Steps:**
1. Navigate to inspect_original_md on Android
...
### Test Case 9: Very long document performance
**Preconditions:** Corpus work with 100KB+ markdown (500+ screens)
**Steps:**
1. Navigate to work with very long content
2. Scroll rapidly through content
3. Jump to bottom with End key
4. Scroll back up

**Expected result:**
- Scrolling remains smooth (no lag)
- Browser handles long document efficiently
- No performance degradation
- Content renders correctly throughout

### Test Case 10: Browser resize behavior
**Preconditions:** Viewing long content
**Steps:**
1. Navigate to corpus viewer
2. Resize browser window wider
3. Resize browser window narrower
4. Observe scroll behavior and header

**Expected result:**
- Scrollbar position adjusts naturally
